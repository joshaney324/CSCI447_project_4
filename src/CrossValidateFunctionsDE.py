...
def cross_validate_classification_de(data_folds, label_folds, crossover_rate, mutation_rate,
    ...
    for i in range(len(data_folds)):
        ...
        weight_vector = de.train(max_iterations)
...
def cross_validate_regression_de(data_folds, label_folds, crossover_rate, mutation_rate, hidden_layer_sizes, num_inputs,
