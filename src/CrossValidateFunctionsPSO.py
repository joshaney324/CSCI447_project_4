...
def cross_validate_classification_pso(data_folds, label_folds, inertia, personal_weight, global_weight, max_velocity,
    ...
    for i in range(len(data_folds)):
        ...
        network = Network(len(hidden_layer_sizes), hidden_layer_sizes, len(train_data[0]), len(train_labels[0]), output_type,
                          [])
...
def cross_validate_tune_regression(data_folds, label_folds, tune_data, tune_labels, inertia, personal_weight, global_weight, max_velocity,
                                   min_velocity, hidden_layer_sizes, num_inputs, num_outputs, output_type,
                                   max_iterations, population_size):
    from Network import Network
...
def cross_validate_tune_classification(data_folds, label_folds, tune_data, tune_labels, inertia, personal_weight,
                                       global_weight, max_velocity, min_velocity, hidden_layer_sizes, num_inputs,
                                       num_outputs, output_type, max_iterations, population_size):
    from Network import Network
